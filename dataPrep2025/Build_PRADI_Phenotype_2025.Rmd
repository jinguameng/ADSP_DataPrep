...
<!--   # Fallback if filtering removed everything (shouldn’t, but safe) -->
...
<!-- library(htmltools)  # needed for tagList() -->

<!-- for (dfn in df_names) { -->
<!--   # Tab header (must be raw markdown => asis) -->
<!--   cat(sprintf("### %s\n\n", dfn)) -->

<!--   # Build the widget -->
<!--   widget <- render_dataset_tab(dfn, common_cols, id_col = "SYSIND") -->

<!--   # Force proper rendering of htmlwidget inside asis chunk -->
