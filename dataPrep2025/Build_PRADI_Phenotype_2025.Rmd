...
## findings: when mergeing, AGE_AT_EXAM can not be used as the key column, cause duplicates existed for some people with different AGE_AT_EXAM
## after rounding up, those obs have same AGE_AT_EXAM values
