...
<!-- print(intersect(names(merged_data_long),c("wrapnum","WRAPNo","VisNo"))) -->
...
<!--   print(intersect(names(get(df_names2_wVisNo[i])),c("wrapnum","WRAPNo","VisNo"))) -->
<!-- } -->
...
<!-- ```{r merge-8} -->
<!-- ## save rds -->
<!-- saveRDS(merged_data_all,paste0(out_directory,"Build_WRAP_woImagingMetaData.rds")) -->
<!-- ``` -->
